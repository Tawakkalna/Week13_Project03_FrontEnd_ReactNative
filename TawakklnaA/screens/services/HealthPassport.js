    ...
    return (
        ...
        <View style={{ flex: 1, backgroundColor: "#121212" }}>
            <View style={styles.nav}>
                    ...
                    <TouchableOpacity style={{paddingTop:30,marginRight:9}}
            ...
            <ScrollView style={[styles.scrollV], { marginTop: 45, flexGrow: 1 }}>
                ...
                >
                    <Image
                    style={{height:61,width:61,marginRight:27,marginBottom:20}}
                    ...
                    <Text style={{ color: "white", marginRight: 25, marginBottom: 50 }}>احمد احمد احمد المطيري</Text>
                </ImageBackground>
                ...
                <View style={styles.dashboard}>
                    <View style={{ alignItems: "flex-end" }}>
                        ...
                        <View style={styles.viewText}>
                            ...
                            <Text style={{ color: "white" }}>123456789</Text>
                        </View>
                        <View style={styles.viewText}>
                        ...
                        <View style={styles.viewText}>
                            ...
                            <Text style={{ color: "green" }}>  محصًن، فايزر-بيونتك</Text>
                        </View>
                        <View style={styles.viewText}>
                            <Text style={{ color: "grey" }}>تاريخ التحصين</Text>
                            <Text style={{ color: "white" }}>2021-07-27</Text>
                        </View>
                        ...
                        <View style={{justifyContent:"center",alignItems:"center",width:"100%"}}>
                             ...
                             <Text style={{ color: "white" }}>نتيجة فحص كورونا PCR غير متوفره</Text>
                        </View>
                        ...
                        <View style={{justifyContent:"center",alignItems:"center",width:"100%"}}>
                             <Image source={insurance}  style={{height:70,width:70,marginVertical:20}}/>
                             <Text style={{ color: "white" }}>حالتك الصحية لا تتطلب وجود تأمين طبي للسفر</Text>
                        </View>
                ...
                >
                    <Text style={{color:"white",fontWeight:"bold"}}>    تحميل الجواز الصحي      
